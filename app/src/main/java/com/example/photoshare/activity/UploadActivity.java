    ...
    private void post(){
        new Thread(() -> {
            ...
            Headers headers = new Headers.Builder()
                    .add("appId", "995af22adef9470fb258f86a729f827a")
                    .add("appSecret", "536363187e2f4e9964644a76643c8c2e4cca0")
            ...
            for(File file:files){
                if(file.exists()){
                    Log.i(TAG,file.getName());//经过测试，此处的名称不能相同，如果相同，只能保存最后一个图片
